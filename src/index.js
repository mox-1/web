...
var spotlightInner1 = $('<div></div>').addClass('layer').addClass('inner').attr('data-depth', 0.4);
var spotlightInner2 = $('<div></div>').addClass('layer').addClass('inner').attr('data-depth', 0.6);

$('.spotlight1').addClass('scene').append(spotlightInner1);
$('.spotlight2').addClass('scene').append(spotlightInner2);
...
$( '.button' ).click(function() {
    ...
    $('.curtains.left').addClass('loaded');
    $('.curtains.right').addClass('loaded');
    $('.audience').addClass('loaded');
    $('.arrow-right').addClass('loaded');
    $('.transparent-light').addClass('loaded');
    $('.spotlight1').addClass('loaded');
    $('.spotlight2').addClass('loaded');
